import { AUTH_BRAND } from '@/core/constants/auth.constant'
                ...
                <section className="bg-primary hidden h-full text-white lg:block lg:w-1/2">
                    <div className="align-center flex h-full flex-col items-center justify-center p-8">
                        <div className="flex size-[96px] items-center justify-center rounded-[12px] bg-white px-[16px] py-[8px]">
                            <img src={AUTH_BRAND.LOGO} alt={AUTH_BRAND.LOGO_ALT} className="h-10 w-auto object-cover" />
                        </div>
                        <h1 className="mt-6 text-4xl font-bold">{AUTH_BRAND.NAME}</h1>
                        <p className="mt-6 text-[18px] font-[500]">{AUTH_BRAND.TAGLINE}</p>
                    </div>
                </section>
